...
#   3. Appends ThinLTO flags via string(APPEND … _INIT) so they compose
...
# ── 3. ThinLTO flags ────────────────────────────────────────────────────────
string(APPEND CMAKE_C_FLAGS_INIT   " -flto=thin -ffunction-sections -fdata-sections")
string(APPEND CMAKE_CXX_FLAGS_INIT " -flto=thin -ffunction-sections -fdata-sections")

string(APPEND CMAKE_EXE_LINKER_FLAGS_INIT    " -fuse-ld=lld -flto=thin -Wl,--gc-sections -Wl,--icf=all")
string(APPEND CMAKE_SHARED_LINKER_FLAGS_INIT " -fuse-ld=lld -flto=thin -Wl,--gc-sections -Wl,--icf=all")
string(APPEND CMAKE_MODULE_LINKER_FLAGS_INIT " -fuse-ld=lld -flto=thin -Wl,--gc-sections -Wl,--icf=all")
