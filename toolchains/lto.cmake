...
set(CMAKE_C_FLAGS_INIT   "-flto -ffunction-sections -fdata-sections")
set(CMAKE_CXX_FLAGS_INIT "-flto -ffunction-sections -fdata-sections")

set(CMAKE_EXE_LINKER_FLAGS_INIT    "-fuse-ld=lld -flto -Wl,--gc-sections -Wl,--icf=all")
set(CMAKE_SHARED_LINKER_FLAGS_INIT "-fuse-ld=lld -flto -Wl,--gc-sections -Wl,--icf=all")
set(CMAKE_MODULE_LINKER_FLAGS_INIT "-fuse-ld=lld -flto -Wl,--gc-sections -Wl,--icf=all")
